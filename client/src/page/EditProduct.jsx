  ...
  return (
    <div className="w-[100%] min-h-screen flex items-center justify-center flex-col text-txtPrimary">
      <div className="bg-bgSecond w-[80%] h-full flex flex-col items-center rounded border-gray-200 border p-5">
        ...
        <form onSubmit={handleEdit} className="w-[100%] h-full flex flex-col items-center">
         ...
         <button className="py-1 px-16 rounded-full bg-bgHover text-txtSecond tracking-wide font-semibold">Edit</button>
        </form>
      </div>
    </div>
    )
